...
var fileData = fs.readFileSync("./assets/Cleaned_Trigrams.txt", { encoding: 'utf-8' });
var trigramData = fileData.split(', ');

/* GET home page. */
router.get('/trigrams', function(req, res, next) {
    console.log('+ trigrams requested');
    console.log(trigramData);
    res.send(trigramData);
});
